...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if not people[person]['mother'] and not people[person]['father']:
            ...
            gene_from_mother = 0.5 * mother_genes if genes else 1 - 0.5 * mother_genes
            gene_from_father = 0.5 * father_genes if genes else 1 - 0.5 * father_genes

            probability *= gene_from_mother * gene_from_father
