...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Deduct known mines from count
        mines = neighbors & self.mines
        count -= len(mines)

        # Remove cells that are already safe or are mines
        ...
        # Update sentences if a cell is known to be safe or a mine
        for sentence in self.knowledge:
